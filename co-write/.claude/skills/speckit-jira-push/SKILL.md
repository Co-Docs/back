...
description: Reconcile (push) the consumer repo's specs → Jira — idempotent, drift-aware,
  fail-closed; the only path that mutates Jira
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: jira:commands/jira-push.md
---
