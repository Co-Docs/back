...
public class OperatorUtil {
    ...
    public List<Operation> parseOperation(List<Operation> newOperations, List<String> operations) {
        List<Operation> savedOperations = operations.stream().map(this::parseOperationUnchecked).toList();
        List<Operation> result = new ArrayList<>(savedOperations);
        result.addAll(newOperations);
        return result;
    }

    public List<String> parseOperation(List<Operation> operations) {
